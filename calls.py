...
from models import Difficulty, QuestionStatus, SubmissionStatus, Problem, Submission

transport = get_transport()

async def get_problems(skip: int = 0, limit: int = 100, status: QuestionStatus = QuestionStatus.SOLVED):
    variables = {
        "filters": {
            "skip": skip,
            "limit": limit,
    ...
    if question_json["userProgressQuestionList"]["totalNum"] > 0:
